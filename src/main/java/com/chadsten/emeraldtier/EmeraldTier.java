...
public class EmeraldTier implements ModInitializer {
    ...
    public static final ArmorItem EMERALD_HELMET = new ArmorItem(EmeraldArmorMaterial.INSTANCE, EquipmentSlot.HEAD,
            new FabricItemSettings().group(ItemGroup.COMBAT));
    public static final ArmorItem EMERALD_CHESTPLATE = new ArmorItem(EmeraldArmorMaterial.INSTANCE, EquipmentSlot.CHEST,
            new FabricItemSettings().group(ItemGroup.COMBAT));
    public static final ArmorItem EMERALD_LEGGINGS = new ArmorItem(EmeraldArmorMaterial.INSTANCE, EquipmentSlot.LEGS,
            new FabricItemSettings().group(ItemGroup.COMBAT));
    ...
    public static final ShovelItem AMETHYST_SHOVEL = new ShovelItem(AmethystToolMaterial.INSTANCE, 1.5F, -3.0F,
            new FabricItemSettings().group(ItemGroup.TOOLS));
    public static final AmethystPickaxeItem AMETHYST_PICKAXE = new AmethystPickaxeItem(AmethystToolMaterial.INSTANCE, 1,
            -2.8F, new FabricItemSettings().group(ItemGroup.TOOLS));
    ...
    public static final ArmorItem AMETHYST_HELMET = new ArmorItem(AmethystArmorMaterial.INSTANCE, EquipmentSlot.HEAD,
            new FabricItemSettings().group(ItemGroup.COMBAT));
    ...
    public static final ArmorItem AMETHYST_LEGGINGS = new ArmorItem(AmethystArmorMaterial.INSTANCE, EquipmentSlot.LEGS,
            new FabricItemSettings().group(ItemGroup.COMBAT));
    ...
    public static final ArmorItem COPPER_HELMET = new ArmorItem(CopperArmorMaterial.INSTANCE, EquipmentSlot.HEAD,
            new FabricItemSettings().group(ItemGroup.COMBAT));
    public static final ArmorItem COPPER_CHESTPLATE = new ArmorItem(CopperArmorMaterial.INSTANCE, EquipmentSlot.CHEST,
            new FabricItemSettings().group(ItemGroup.COMBAT));
    ...
    private void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier("emeraldtier", "copper_pickaxe"), COPPER_PICKAXE);
        Registry.register(Registry.ITEM, new Identifier("emeraldtier", "copper_axe"), COPPER_AXE);
        Registry.register(Registry.ITEM, new Identifier("emeraldtier", "copper_hoe"), COPPER_HOE);
        Registry.register(Registry.ITEM, new Identifier("emeraldtier", "copper_helmet"), COPPER_HELMET);
